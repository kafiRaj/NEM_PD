...
public class Application{
 ...
 MasterData info = new MasterData(); 
  ...
  public void submitApplication() throws Exception {
    ...
    WebElement consumerAccountNumber = wait.until(ExpectedConditions.elementToBeClickable(By.id("NEM_PD_NetMetering_NemApplicationPublicDialog0_ConsumerAccountNumber")));
